...
// Shader Names
char *vertexFileName = "../dirlightdiffambpix.vert";//../src/Shaders/VertexShader.vert";
char *fragmentFileName = "../dirlightdiffambpix.frag";//"../src/Shaders/FragmentationShader.frag";
...
//static const std::string modelname = "../c7130424fe904e71b69f4c5d02c55db3/c7130424fe904e71b69f4c5d02c55db3.obj";//../bench.obj";
...
float transx = 3, transy = 2, transz = 10;
...
{
	std::string hFile =  "../bench.obj";
	//check if file exists
	//std::ifstream fin(hFile.c_str());
	...
	{
		printf("Fucking Couldn't open file: %s\n", pFile.c_str());
...
void processKeys(unsigned char key, int xx, int yy) 
{
	...
	switch(key) {
		...
		case 'w': transy += f; break;
		case 's': transy += -f; break;
		case 'a': transx += -f; break;
		case 'q': transx += f; break;
		case 'e': transz += -f; break;
		case 'd': transz += f; break;
	}
